...

{
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{l|l|X}
     	...
     	FR-2 & Must & The beacons must connect to a phone's bluetooth and application.\\ \hline
     	FR-3 & Must & The system must charge a person based on account/travel location. \\
     	\hline
     	FR-4 & Optional & The system should verify which train is responsible for sending which part of the data. \\
     	\hline
     	FR-5 & Must & Phones must be verified based on accounts.\\ \hline        
        ...
        \\	\hline
	    FR-13 & Optional & The beacons register both logged in and not logged in users and match the account with the phone even if the user logs in later on during the journey. \\ \hline
...
\subsection{Reliability}
{
  ...
  \begin{table}[H]
    \centering
    \begin{tabularx}{\textwidth}{l|l|X}
      NF-2.1 &Must & The local storage units inside the train must be available 99.9999\% of the time during a train journey.\\ \hline
      NF-2.2 &Must & The system must be fault tolerant.  \\ \hline
      NF-2.3 &Must & At least 80\% of the beacons inside a train must be operational at all times when the train is working. \\ \hline
      NF-2.4 &Must & The central Server unit must be 99.999\% available, with backups. \\  
    \end{tabularx}
  \end{table}
}
